...
# === Linkovi autora (Drasko Furundzic) ===
ORCID_URL = "https://orcid.org/0000-0002-1711-1474"
SCHOLAR_URL = "https://scholar.google.com/citations?user=wF06R_gAAAAJ&hl=en"
...
def kreiraj_html_email(preporuka: str) -> str:
    ...
    <html>
      <body style="font-family: Arial, sans-serif; color: #333;">
        ...
        <ul>
          <li><a href="{ORCID_URL}" target="_blank" rel="noopener noreferrer">ORCID profil</a></li>
          <li><a href="{SCHOLAR_URL}" target="_blank" rel="noopener noreferrer">Google Scholar</a></li>
          <li><a href="https://tvojadomena.com/profil" target="_blank" rel="noopener noreferrer">Vaš profil</a></li>
          <li><a href="https://tvojadomena.com/analiza" target="_blank" rel="noopener noreferrer">Pregled analiza</a></li>
        </ul>
